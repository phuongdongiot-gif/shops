...
<footer id="colophon" class="site-footer bg-dark text-gray-300 py-16 mt-auto border-t-[8px] border-primary">
	<div class="container mx-auto px-6">
		...
		<div
			class="flex flex-col items-center justify-center mb-8 text-center text-sm md:text-base leading-relaxed max-w-4xl mx-auto border-b border-primary/30 pb-8">
			<h3 class="text-2xl font-bold text-[#ffeb3b] mb-6 uppercase tracking-wider">CÔNG TY TNHH BAO BÌ PHỤ GIA THỰC
				PHẨM 3EM</h3>
			<div class="space-y-4">
				<p><strong class="text-white font-semibold">Trụ sở chính:</strong> 160/49/34 Huỳnh Thị Hai, Phường Tân
					Chánh Hiệp, Quận 12, Tp. Hồ Chí Minh</p>
				<p><strong class="text-white font-semibold">Chi Nhánh:</strong> An Thổ, Phổ An, Thị Xã Đức Phổ, Quảng
					Ngãi</p>
			</div>
		</div>
		...
		<div
			class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 text-sm md:text-base max-w-5xl mx-auto border-b border-primary/30 pb-10">
