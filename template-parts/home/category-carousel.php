		...
		if (!empty($valid_categories)):
			...
			<style>
				...
				.categorySwiper:not(.swiper-initialized) .swiper-slide {
					flex: 0 0 auto;
					width: 160px; /* Độ rộng cho mobile */
				}
				@media (min-width: 768px) {
					.categorySwiper:not(.swiper-initialized) .swiper-slide { width: 200px; }
				}
				@media (min-width: 1024px) {
					.categorySwiper:not(.swiper-initialized) .swiper-slide { width: 250px; }
				}
			</style>
