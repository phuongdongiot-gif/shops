                ...
                if ( $latest_products->have_posts() ) :
                    while ( $latest_products->have_posts() ) : $latest_products->the_post();
                        ...
                        <div class="flex gap-4 items-start pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                            ...
                            <div>
                                <h4 class="text-[13px] font-bold uppercase text-dark leading-tight hover:text-primary transition-colors mb-1"><a href="<?php the_permalink(); ?>"><?php echo wp_trim_words( get_the_title(), 8, '...' ); ?></a></h4>
