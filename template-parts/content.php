...
<article id="post-<?php the_ID(); ?>" <?php post_class('mb-6 md:mb-10'); ?>>
	<header class="entry-header mb-4 md:mb-6">
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			<div class="entry-meta flex flex-wrap items-center gap-3 md:gap-4 text-[12px] md:text-[13px] text-gray-500 font-medium mb-4 md:mb-6 pb-4 md:pb-6 border-b border-gray-100">
				<!-- Author -->
